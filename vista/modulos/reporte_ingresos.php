...
<div class="card  mb-2 mt-3 bordered">
  ...
  <h3><strong>REPORTE DE ALUMNOS</strong></h3>
...
<div class="col-3">
 ...
 <strong>DE:</strong> <input type="date" class="form-control" id="fecha1_pre">
</div>
<div class="col-3">

 <strong>A:</strong> <input type="date" class="form-control" id="fecha2_pre">
</div>
...
<div class="card bordered">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-homefear" role="tab"
      aria-controls="pills-home" aria-selected="true"><strong><h4>INGRESADOS</h4></strong></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profilefear" role="tab"
      aria-controls="pills-profile" aria-selected="false"><strong><h4>AÚN NO INGRESAN</h4></strong></a>
  </li>
</ul>
